...
export default function LoginForm() {
  ...
  //     try {
  //       const response1 = await getFromAPI("/branch_list");
  //       setBranchList(response1.branch_lst);
  //     } catch (error) {
    ...
    <Container maxWidth="xs" className="login_c">
      <Paper elevation={3} style={{ padding: "40px", textAlign: "center" }}>
        ...
        {/* <FormControl fullWidth style={{textAlign: "left" }}>
              <InputLabel id="branch-label">Select your branch</InputLabel>
              <Select
              ...
              >
                  {branchList.map((item) => (
                  <MenuItem key={item.master_branch_pk} value={item} name={item.master_branch_name}>
